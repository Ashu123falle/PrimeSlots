...
const MyBookings = () => {
    return (
    <div className="w-full  flex flex-col md:flex-row justify-start items-start m-1 lg:m-10 sm:m-3 mb-10 md:mb-20">
        <div className="w-full lg:w-1/2 flex flex-row ">
            <Image src='/assets/myBookingsImage.jpg' height={80} width={100}   alt="light" />
            <div className="ml-1 md:ml-3">
                <h1 className="text-zinc-900 text-base lg:text-xl font-medium font-['Inter'] leading-snug">Title of the media will come here....</h1>
                ...
                <p className="text-zinc-800 text-sm font-normal font-['Figtree'] underline leading-tight">#125468</p>
                <div>
        ...
        <div className="w-full lg:w-1/3 mt-5 md:mt-0 flex flex-row justify-between items-start">
            <div>
