        ...
        <form className="flex flex-col md:flex-row gap-4 w-auto flex-grow lg:flex-shrink">
          ...
          <div className='flex flex-col w-full md:w-2/5 mx-8'>
            ...
            <div>
              ...
              <input type="url" id="website" name="website" className="mt-1 p-2 border border-gray-300 rounded-md w-full md:w-full bg-gray-200 h-[46px]" placeholder='www.abc.com'/>
            </div>
          </div>
        </form>
