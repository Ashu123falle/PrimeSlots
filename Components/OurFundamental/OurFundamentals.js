            ...
            <div className="main p-5 sm:p-10 space-y-10 xl:px-28 sm:space-y-16 md:space-y-20">
                ...
                <div className='flex flex-col justify-evenly md:flex-row gap-5 md:gap-0'>
                    <div className="p-5 flex gap-3">
                        <div>
                            <img src='/assets/Vector0.svg' alt="vector0" className='w-[30px] h-[90px] sm:w-[40px] sm:h-[90px] md:w-[40px] md:h-[90px] mt-10' />
                        </div>
                    ...
                    <div className="p-5 flex gap-3">
                        <div>
                            <img src='/assets/Vector2.svg' alt="vector2" className='w-[30px] h-[90px] sm:w-[40px] sm:h-[90px] md:w-[40px] md:h-[90px] mt-10' />
                        </div>

                        <div className="content grid gap-4 md:gap-6 lg:gap-10">
                            <img src='/assets/Group2.svg' alt="group2" className='w-[15%] md:w-[45px] sm:w-[10%]' />
                            <h1 className='text-4xl uppercase text-[#6979F8] font-[Playfair]'>Lorem Ipsum is simply</h1>
                            <p className='leading-5 text-[27.03px] font-[Nexa] text-[#9F9E9E]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                        </div>
                    </div>
                    ...
                    <div className="p-5 flex gap-3">
                        <div>
                            <img  alt="vector3" src='/assets/Vector3.svg' className='w-[30px] h-[90px] sm:w-[40px] sm:h-[90px] md:w-[40px] md:h-[90px] mt-10' />
                        </div>

                        <div className="content grid gap-4 md:gap-6 lg:gap-10">
                            <img src='/assets/Group3.svg' alt="group3" className='w-[15%] md:w-[45px] sm:w-[10%]' />
                            <h1 className='text-4xl uppercase text-[#6979F8] font-[Playfair]'>Lorem Ipsum is simply</h1>
                            <p className='leading-5 text-[27.03px] font-[Nexa] text-[#9F9E9E]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                        </div>
                    </div>
