        ...
        <>
            <div className="maincontainer space-y-10 md:py-10 lg:py-14 sm:space-y-14 p-5 md:flex flex-col justify-center items-center lg:px-24 xl:px-44">
                <div className='text-center space-y-2 md:px-10 lg:px-28'>
                    <h1 className='text-2xl sm:text-3xl md:text-4xl font-semibold font-[Playfair]'>Testimonials</h1>
                    <p className="text-xs sm:text-[0.8rem] md:text-[0.9rem] font-[Figtree] font-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>




                <div className="image  md:space-x-5 md:flex md:justify-center md:items-center">
