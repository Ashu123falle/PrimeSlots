...
const ServiceSectionCardBlue = (props) => {
    ...
    return (
        <li className="m-10 flex flex-col justify-center items-center">
            <div className="w-20 h-20 bg-zinc-300 rounded-full flex flex-row justify-center items-center">
                <div className="w-[58px] h-[58px] bg-[#131C5F] rounded-full flex justify-center items-center">
...
export default ServiceSectionCardBlue
