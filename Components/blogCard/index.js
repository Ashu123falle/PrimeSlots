    ...
    return (
            <li className="list-none rounded-xl w-[350px] h-[380px] shrink-0  sm:w-[290px] md:w-[250px] bg-white shadow border border-slate-300 
                ...
                text-indigo-600 text-sm font-normal font-['Figtree'] leading-tight my-1">{description1}</li>
                        <li className="h-[25px]  p-2 flex items-center bg-indigo-100 bg-opacity-60 rounded 
                text-indigo-600 text-sm font-normal font-['Figtree'] leading-tight my-1">{description2}</li>
                        <li className="h-[25px] p-2 flex items-center bg-indigo-100 bg-opacity-60 rounded 
                text-indigo-600 text-sm font-normal font-['Figtree'] leading-tight my-1">{description3}</li>
                        <li className="h-[25px] p-2 flex items-center bg-indigo-100 bg-opacity-60 rounded 
                text-indigo-600 text-sm font-normal font-['Figtree'] leading-tightmy-1 ">{description4}</li>
                    </ul>
