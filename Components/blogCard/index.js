...
export default function BlogCard(props) {
    return (
            ...
            <li className="list-none rounded-xl w-11/12 h-[400px]  max-w-[400px] sm:w-[300px] bg-white shadow border border-slate-300 
                ...
                <div className="px-6 pt-4 pb-2  flex flex-col w-[100%] justify-between h-[50%]">
                 ...
                 gap-[4.71px] items-start self-start">
                    ...
                    <p className="pt-1 text-neutral-950 text-lg font-normal font-['Figtree'] leading-tight">{props.name}</p>
