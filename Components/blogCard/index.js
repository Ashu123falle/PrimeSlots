...
export default function BlogCard() {
    ...
    return (
        <li className="list-none rounded-xl shadow-lg w-[240px] h-[380px]
         ...
         items-start inline-flex m-3">
            ...
            <p className="pt-2 text-neutral-950 text-lg font-normal font-['Figtree'] leading-tight">Title will come here...</p>
