...
<div className="mb-16">
        ...
        <div className="px-4 md:flex w-full mt-9">
          <ul className="flex flex-col gap-3 mx-9 my-9">
        ...
        <ul className="w-full flex-col gap-6">
          <li class="flex flex-col md:flex-row justify-around lg:items-center bg-white rounded-xl shadow p-1 sm:p-3 md:p-5 m-2">
            <h1 class="text-slate-900 text-2xl font-medium font-['Figtree'] md:w-[250px] lg:w-[350px]">Wordpress Developer</h1>
            <div className="w-full flex justify-around items-center">

            <div className="">
              <h1 class="text-neutral-300 text-base font-medium font-['Figtree']">Experience</h1>
              <h1 class="text-slate-900 text-2xl font-semibold font-['Figtree']">2 Years</h1>
            </div>

            <div className="">
              <h1 class="text-neutral-300 text-base font-medium font-['Figtree']">Deadline</h1>
              <h1 class="text-slate-900 text-2xl font-semibold font-['Figtree']">2021-05-08</h1>
            </div>
          ...
          <li class="flex flex-col md:flex-row justify-around lg:items-center bg-white rounded-xl shadow p-1 sm:p-3 md:p-5 m-2">
            ...
            <div className="">
              <h1 class="text-neutral-300 text-base font-medium font-['Figtree']">Deadline</h1>
              <h1 class="text-slate-900 text-2xl font-semibold font-['Figtree']">2024-1-27</h1>
            </div>
          ...
          <li class="flex flex-col md:flex-row justify-around lg:items-center bg-white rounded-xl shadow p-1 sm:p-3 md:p-5 m-2">
            ...
            <div className="">
              <h1 class="text-neutral-300 text-base font-medium font-['Figtree']"></h1>
              <h1 class="text-slate-900 text-2xl font-semibold font-['Figtree']"></h1>
            </div>
