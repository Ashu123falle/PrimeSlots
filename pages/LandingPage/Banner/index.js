...
const Banner = () => {
    return(
        ...
        <div className="w-[100vw] rgba(35, 29, 32, 0.89) bg-opacity-25 lg:h-[140vh] sm:h-[190vh] md:h-[150vh] 2xl:h-[130vh]" style={{backgroundImage: "url('https://s3-alpha-sig.figma.com/img/8361/dc28/d4780ff4f4143e28302cc03f7a231643?Expires=1704672000&Signature=Xz6BeRagExtpnmtcKTEKZ90M7Z8CPeuMf3G~dJ~3WILoceH79CufiXkqsWCa-HXVhiHOfCtnzuequs1UiuYMlQ4juPiF-qW0odF5s5M5QoNGsL6TMiCmbrGHiFMO5Zhryx5nOzJeJJjVEYq3RGCfaSaXO~W-9eNmKcYxNWUmWEZKiCPomDw9-wjM86SK9CwU1904tjGQTBRS8tYc3XFhoCnY2iIu27LEIe67pWncsinHx1JyBn9VSBQVH5K1A~vDfZWDKdV46Otcdo-WQakXuV67xHpqYP0AjgPZ-rDYl6t76XqMtWOSom6oGrlfAsocG2JeWu9bGItHkzFCMk8quA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4')", backgroundSize: "cover", width:"100%" }}>
            ...
            <div
                className={
                "text-[#ffffff] text-left font-['Inter-Medium',_sans-serif] text-2xl font-normal w-[70vw] absolute left-[calc(10vw)] top-[calc(5vw)]"
                }
            >
            ...
            <div
            className={
                "text-[#ffffff] text-left font-['PlayfairDisplay-Bold',_sans-serif] text-[180.3414001464844px] font-bold relative left-[calc(15vw)] top-[calc(10vw)] z-10"
            }
            >
            OOH{" "}
            </div>
            ...
            <div className="button self-center left-[calc(40vw)] relative top-[calc(-45vw)]">
                <button className="bg-[#ffffff] rounded-[36px] w-[140px] h-[52px]  text-[#0e0d0d] text-center text-[18.40671920776367px] font-semibold font-['Figtree-SemiBold',_sans-serif]">Explore Now</button>
