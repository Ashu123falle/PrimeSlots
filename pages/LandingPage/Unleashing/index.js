...
const Unleasing = () => {
    return (
        <>
            <div className="main h-[260px] sm:h-[280px] md:h-[300px] bg-[#F9FBFD] flex justify-center items-center">
                <div className=' xl:p-7 lg:p-5 xl:w-[75%] lg:w-[85%] md:w-[90%] sm:w-[92%] w-[90%] flex sm:flex-row flex-col justify-center items-center lg:space-x-10 sm:space-y-0 space-y-7'>
                    ...
                    <div className="button sm:w-[50%] md:w-[80%] lg:w-full xl:w-full flex md:justify-center md:items-center sm:justify-end">
                        <button className='text-sm px-12 py-2 lg:px-16 lg:py-3 md:px-12 md:py-3 sm:px-8 sm:py-3 bg-[#F5167E] text-[#FFF] rounded-full shadow-xl shadow-[rgba(61, 55, 241, 0.25)]'>Get Started Now!</button>
                    </div>
                </div>
            </div>
        </>
