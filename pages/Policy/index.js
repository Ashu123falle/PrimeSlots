...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="pl-20 pr-16 ml-8 pb-20 mb-52 mt-10  text-teal-900  font-['figtree'] max-md:pl-6 max-md:pr-2 max-md:ml-0 max-md:pb-12">
        ...
        <p className='text-lg font-medium'>Last updated: September 25, 2023</p>
        <br></br>

        <p className='text-lg font-medium'>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p> 
        <br></br>

        <p className='text-lg font-medium'>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.</p>
        <br></br>
        <br></br> 
        ...
        <p className='text-lg font-medium'>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural. </p>
        <br></br>
        
        <h2 className='text-xl font-bold'>Definitions:</h2>
        <br></br>
        <h2 className='text-xl font-bold'> For the purposes of this Privacy Policy:</h2>
        <br></br>
        <ul className='px-6 text-lg font-medium list-disc'>
            ...
            <li>Website refers to Primeslots, accessible from <Link href='http://primeslots.co.in/' className='text-indigo-500 underline'>http://primeslots.co.in/</Link></li>
            <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>
        <br></br>
        <h2 className='text-lg font-medium'>Collecting and Using Your Personal Data:</h2>
        <br></br>
       ...
       <p className='text-lg font-medium'>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
       ...
       <br></br>
         ...
         <br></br>
         <p className='text-lg font-medium'>We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device. Information from Third-Party Social Media Services</p> 
         <br></br>
         
         <h2 className='text-xl font-semibold'>The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:</h2> 
         ...
         <br></br>
         <p className='text-lg font-medium'>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</p>
         <ul className='px-6 text-lg font-medium list-disc'>
        ...
        <br></br>
        <p className='text-lg font-medium'> The Company may use Personal Data for the following purposes</p>
        <br></br>
        <p className='text-lg font-medium'>To provide and maintain our Service, including to monitor the usage of our Service.</p>
        <br></br>
        <ul className='px-6 text-lg font-medium list-disc'>
        ...
        <p className='text-lg font-medium'>We may share Your personal information in the following situations:</p>
        <ul className='px-6 text-lg font-medium list-disc'>
        ...
        <br></br>
        <p className='text-lg font-medium'>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p> 
        <br></br>
        <p className='text-lg font-medium'>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
        <br></br>
        ...
        <br></br>
        <p className='text-lg font-medium'>You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You. Our Service may give You the ability to delete certain information about You from within the Service.</p>
        <br></br>
        <p className='text-lg font-medium'>You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us. Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
        <br></br>

        <h2 className='text-xl font-bold'>Disclosure of Your Personal Data</h2>
        <br></br>
        <h3 className='text-xl font-semibold' >Business Transactions</h3>
        <br></br>
        <p className='text-lg font-medium'>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <br></br>
         <h3 className='text-xl font-semibold' >Law enforcement</h3>
         <br></br>
         <p className='text-lg font-medium'>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
         <br></br>
          
          <h3 className='text-xl font-semibold' >Other legal requirements </h3>
           <br></br>
           <p className='text-lg font-medium'>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
           <ul className='px-6 text-lg font-medium list-disc'>
            ...
            <h3 className='text-xl font-semibold' >Links to Other Websites</h3>
             ...
             <p className='text-lg font-medium'>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p><br></br>
              ...
              <h3 className='text-xl font-bold'>Contact Us </h3>   
               <br></br>
               <p className='text-lg font-medium'>If you have any questions about this Privacy Policy, You can contact us: </p> 
                <ul className='px-6 text-lg font-medium list-disc'>
                  <li>By email: <a href="mailto:info@primeslots.co.in" className='text-indigo-500 underline'>info@primeslots.co.in</a></li>
                  <li>By phone number: <a href="tel:+9021164360" className='text-indigo-500 underline'>9021164360</a></li>
                </ul>
